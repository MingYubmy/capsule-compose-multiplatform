package dev.mingyubmy.capsule.continuities

import androidx.compose.runtime.Immutable
import androidx.compose.ui.util.fastCoerceAtLeast
import androidx.compose.ui.util.fastCoerceIn
import dev.mingyubmy.capsule.AdvancedContinuity
import dev.mingyubmy.capsule.Continuity
import dev.mingyubmy.capsule.core.Point
import dev.mingyubmy.capsule.path.PathSegments
import dev.mingyubmy.capsule.path.PathSegmentsBuilder
import dev.mingyubmy.capsule.path.buildPathSegments
...
data class G2Continuity(
    ...
    override fun createStandardRoundedRectanglePathSegments(
        ...
        val extFracTL = dev.mingyubmy.capsule.lerp(capsuleProfile.extendedFraction, profile.extendedFraction, ratioTL)
        val extFracTR = dev.mingyubmy.capsule.lerp(capsuleProfile.extendedFraction, profile.extendedFraction, ratioTR)
        val extFracBR = dev.mingyubmy.capsule.lerp(capsuleProfile.extendedFraction, profile.extendedFraction, ratioBR)
        val extFracBL = dev.mingyubmy.capsule.lerp(capsuleProfile.extendedFraction, profile.extendedFraction, ratioBL)
        ...
        val bezKScaleTLV =
            dev.mingyubmy.capsule.lerp(capsuleProfile.bezierCurvatureScale, profile.bezierCurvatureScale, ratioTLV)
        val bezKScaleTLH =
            dev.mingyubmy.capsule.lerp(capsuleProfile.bezierCurvatureScale, profile.bezierCurvatureScale, ratioTLH)
        val bezKScaleTRH =
            dev.mingyubmy.capsule.lerp(capsuleProfile.bezierCurvatureScale, profile.bezierCurvatureScale, ratioTRH)
        val bezKScaleTRV =
            dev.mingyubmy.capsule.lerp(capsuleProfile.bezierCurvatureScale, profile.bezierCurvatureScale, ratioTRV)
        val bezKScaleBRV =
            dev.mingyubmy.capsule.lerp(capsuleProfile.bezierCurvatureScale, profile.bezierCurvatureScale, ratioBRV)
        val bezKScaleBRH =
            dev.mingyubmy.capsule.lerp(capsuleProfile.bezierCurvatureScale, profile.bezierCurvatureScale, ratioBRH)
        val bezKScaleBLH =
            dev.mingyubmy.capsule.lerp(capsuleProfile.bezierCurvatureScale, profile.bezierCurvatureScale, ratioBLH)
        val bezKScaleBLV =
            dev.mingyubmy.capsule.lerp(capsuleProfile.bezierCurvatureScale, profile.bezierCurvatureScale, ratioBLV)

        // arc stuffs

        // arc fractions of each corner
        val arcFracTL = dev.mingyubmy.capsule.lerp(capsuleProfile.arcFraction, profile.arcFraction, ratioTL)
        val arcFracTR = dev.mingyubmy.capsule.lerp(capsuleProfile.arcFraction, profile.arcFraction, ratioTR)
        val arcFracBR = dev.mingyubmy.capsule.lerp(capsuleProfile.arcFraction, profile.arcFraction, ratioBR)
        val arcFracBL = dev.mingyubmy.capsule.lerp(capsuleProfile.arcFraction, profile.arcFraction, ratioBL)
    ...
    override fun createHorizontalCapsulePathSegments(width: Double, height: Double): PathSegments {
        ...
        val bezKScaleH =
            dev.mingyubmy.capsule.lerp(capsuleProfile.bezierCurvatureScale, profile.bezierCurvatureScale, ratioH)
    ...
    override fun createVerticalCapsulePathSegments(width: Double, height: Double): PathSegments {
        ...
        val bezKScaleV =
            dev.mingyubmy.capsule.lerp(capsuleProfile.bezierCurvatureScale, profile.bezierCurvatureScale, ratioV)
        val arcFrac = capsuleProfile.arcFraction
        val bezierV =
            resolveBezier(
                G2ContinuityProfile(
